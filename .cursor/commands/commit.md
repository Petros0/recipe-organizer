...
Before commiting, also run the tests to see if everything is still working as expected. 

If the commit doesn't have any new changes and just fixes a previous commit, do an amend instead.
